import {
    FRIEND_GET_SUCCESS, MESSAGE_GET_SUCCESS, SEND_MESSAGE_SUCCESS, SOCKET_MESSAGE, UPDATE_FRIEND_MESSAGE, MESSAGE_SEND_SUCCESS_CLEAR, SEEN_MESSAGE
...
export const messengerReducer = (state = messengerState, action: any) => {
    ...
    if (action.type === UPDATE_FRIEND_MESSAGE) {
        ...
        const newFriends = [{
            ...
            ...state.friends[index],
            lastMessageInfo: action.payload.messageInfo
